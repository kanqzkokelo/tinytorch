...
static void micro_kernel(const float *A, const float *bp0, float *C,
    ...
    if (first_block) {
        __asm__ __volatile__(
            ...
            "vmovaps 0x20(%[bp]), %%ymm12\n\t"
            "vmovaps 0x40(%[bp]), %%ymm13\n\t"
            ...
            "vfmadd231ps %%ymm12, %%ymm14, %%ymm10\n\t"
            "vfmadd231ps %%ymm13, %%ymm14, %%ymm11\n\t"
            "vmovaps 0x60(%[bp]), %%ymm12\n\t"
            "vmovaps 0x80(%[bp]), %%ymm13\n\t"
            ...
            "vfmadd231ps %%ymm12, %%ymm14, %%ymm10\n\t"
            "vfmadd231ps %%ymm13, %%ymm14, %%ymm11\n\t"
            "vmovaps 0xa0(%[bp]), %%ymm12\n\t"
            "vmovaps 0xc0(%[bp]), %%ymm13\n\t"
            ...
            "vfmadd231ps %%ymm12, %%ymm14, %%ymm10\n\t"
            "vfmadd231ps %%ymm13, %%ymm14, %%ymm11\n\t"
            "vmovaps 0xe0(%[bp]), %%ymm12\n\t"
            "vmovaps 0x100(%[bp]), %%ymm13\n\t"
